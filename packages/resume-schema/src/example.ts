      ...
      items: [
        {
          ...
          <b>项目介绍：</b>「智能简历构建器」是一款基于 AI 的现代化 Web 应用，旨在帮助用户快速生成高质量、专业化的简历。项目采用 Vue 3 和 Nuxt 3 构建，结合 TypeScript 确保类型安全，借助 Vite 实现高效开发与构建流程，并通过 Tailwind CSS 和 Shadcn Vue 打造优雅且一致的 UI 风格。核心功能依托 LangChain.js 集成 AI 大模型，支持一键生成简历、内容智能优化及辅助撰写等特性，大幅提升用户体验与效率；<br/>
          <ul>
            <li><b>Monorepo 架构：</b>利用 Turborepo 和 Pnpm 搭建 Monorepo 架构，统一管理多子应用与共享组件库，提升代码复用性与维护效率；<br/></li>
            <li><b>高复用组件库：</b>基于 Shadcn Vue 二次封装，设计并实现高复用 UI 组件体系，确保风格统一并加速开发迭代；<br/></li>
            <li><b>AI模块：</b>通过 LangChain.js 调用智谱 API，设计并实现 resume-ai 库，提供 AI 助手、AI 优化和 AI 生成等功能，显著提高简历编写效率<br/></li>
            <li><b>简历构建与预览：</b>设计并开发简历编辑器，采用 iframe 嵌入预览，利用 postMessage 实现数据实时同步，提升交互流畅性<br/></li>
            <li><b>数据模型：</b>开发 resume-schema 库用于定义和验证简历数据结构，并基于 Zod 进行数据模式校验，确保简历数据的完整性和一致性，支持多种简历模板配置<br/></li>
            <li><b>工具库：</b>构建 resume-utils 工具库，集成日期处理、剪贴板、打印导出简历操作等功能，优化开发与用户体验<br/></li>
          </ul>
          `,
          role: "全栈开发",
